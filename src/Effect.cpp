...
int Effects::apply_effect(int id, Data data, Complet_Needs complet_needs)
{
	switch (id) //0=do nothing/ 1 = take on action /2 = move 2 cell /3 = move 3 cell /4 = farib/5 = show target hand
	{
	case 1:effect4(data, complet_needs); return 0;
	case 2:effect11(data, complet_needs); return 1;
	case 3:effect5(data, complet_needs); return 0;
	case 4:effect3(data, complet_needs); return 2;
	case 5:effect2(1, data, complet_needs); return 0;
	case 6:effect2(4, data, complet_needs); return 0;
	case 7:effect6(data, complet_needs); return 0;
	case 8:effect2(2, data, complet_needs); return 0;
	case 9:return 3;
	case 10:return 4;
	case 11:effect2(3, data, complet_needs); return 0;
	case 12:effect1(1, data, complet_needs); return 0;
	case 13:effect12(data, complet_needs); return 5;
	case 14:effect7(data, complet_needs); return 0;
	case 15:effect1(2, data, complet_needs); return 0;
	case 18:return 3;
	case 17:return 0;
	case 19:effect13(data, complet_needs); return 0;
	case 20:effect9(data, complet_needs); return 0;
	case 21:effect10(data, complet_needs); return 0;
	case 22:effect8(data, complet_needs); return 0;
	case 23:return 4;
	case 24:return 5;
	case 25:return 0;
	}
}
int Effects::rm(int min, int max)
{
	static std::mt19937
...
void Effects::effect1(int a, Data data, Complet_Needs complet_needs)
{
...
void Effects::effect2(int b, Data data, Complet_Needs complet_needs)
{
...
void Effects::effect3(Data data, Complet_Needs complet_needs)
{
	//eqvay siri napazir
...
void Effects::effect4(Data data, Complet_Needs complet_needs)
{
	//qosle khon 
...
void Effects::effect5(Data data, Complet_Needs complet_needs)
{
	//shekar kon
...
void Effects::effect6(Data data, Complet_Needs complet_needs)
{
	//teshnegi baray baqa
...
void Effects::effect7(Data data, Complet_Needs complet_needs)
{
	//ostad taqir chehre
...
void Effects::effect8(Data data, Complet_Needs complet_needs)
{
...
void Effects::effect9(Data data, Complet_Needs complet_needs)
{
	//zed hamle
...
void Effects::effect10(Data data, Complet_Needs complet_needs)
{
...
void Effects::effect11(Data data, Complet_Needs complet_needs)
{
	//form meh
	data.mapManager.move(complet_needs.location, data.team[0]);
}

void Effects::effect12(Data data, Complet_Needs complet_needs)
{
	//hazfe namomken ha
...
void Effects::effect13(Data data, Complet_Needs complet_needs)
{
	//stentag sterategik
